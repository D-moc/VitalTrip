...
//   /* -------------------------------------------------------------------------- */
//   useEffect(() => {
//     const saved = localStorage.getItem("vital_ai_chat");
//     if (saved) {
...
//           role: "assistant",
//           content:
//             "👋 Hi! I’m Vital AI — your travel assistant. How can I help you today?",
//         },
//       ];
//       setMessages(initial);
//       localStorage.setItem("vital_ai_chat", JSON.stringify(initial));
//     }
//   }, []);
...
//       localStorage.setItem("vital_ai_chat", JSON.stringify(trimmed));
//     }
//   }, [messages]);
...
//       await new Promise((r) => setTimeout(r, 40)); // speed control (ms per word)
//       current += (i === 0 ? "" : " ") + words[i];
...
//           role: "assistant",
//           content:
//             "⚠️ Sorry, I couldn’t process that right now. Please try again later.",
//         },
//       ]);
//     } finally {
//       setLoading(false);

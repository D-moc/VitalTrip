    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#003366] via-[#006666] to-[#00b4d8] text-white">
      <AuthCard title="Captain Signup ⚓" subtitle="Register as an authorized Captain">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <motion.button
            whileTap={{ scale: 0.95 }}
            className="w-full py-3 bg-gradient-to-r from-teal-400 to-cyan-500 rounded-lg text-white font-semibold shadow-lg hover:shadow-cyan-400/40 transition-all"
            disabled={loading}
          >
